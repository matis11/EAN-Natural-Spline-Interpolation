...
type
  interval = record
    a, b: Extended end;
    vector = array [0 .. 110] of Extended;
    ivector = array [0 .. 110] of interval;
    vector1 = array [0 .. 110] of Extended;
    vector2 = array [0 .. 1110] of Extended;
    matrix = array [0 .. 100, 0 .. 100] of Extended;
    imatrix = array [0 .. 100, 0 .. 100] of interval;
    matrix1 = array [0 .. 10, 0 .. 20] of Extended;
    matrix2 = array [0 .. 110, 0 .. 6] of Extended;
    matrix3 = array [0 .. 7, 0 .. 110] of Extended;
    atmatrix =
    procedure(x: Extended; m: Integer; var a: matrix);
    ftfunction =
    procedure(x: Extended; m: Integer; var f: vector);
      ...
      begin
        ...
        repeat
          ...
          if (w.a <> 0) and (w.b <> 0) then
            ...
            if (Abs(w.a - w1.a) < 1E-18) and (Abs(w.b - w1.b) / Abs(w.b) < 1E-18)
            then
              finished := True
            else
          else if w.a <> 0 then
            if (Abs(w.a - w1.a) / Abs(w.a) < 1E-18) and (Abs(w.b - w1.b) < 1E-18)
            then
              finished := True
            else
